    ...
    <section className="py-24 bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="mt-2 font-display text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group rounded-3xl bg-navy-900/80 border border-navy-800/90 p-7 backdrop-blur-sm transition-all duration-300 hover:border-gold-500/50 hover:-translate-y-1.5 hover:shadow-xl"
              >
        ...
        <div className="mt-16 rounded-3xl bg-gradient-to-r from-navy-900 via-navy-850 to-navy-900 border border-navy-700/80 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
          <div>
            <span className="text-xs font-bold uppercase tracking-wider text-gold-400">
              Personalized Assistance
            </span>
            <h3 className="mt-1.5 font-display text-2xl sm:text-3xl font-black text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3.5 w-full md:w-auto flex-shrink-0">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-white text-navy-950 hover:bg-slate-100 active:scale-95 px-7 py-4 text-xs font-extrabold shadow-lg transition-all"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white px-7 py-4 text-xs font-extrabold shadow-lg transition-all"
            >
